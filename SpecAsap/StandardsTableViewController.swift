...
class StandardsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
         return AppDelegate.standardNames.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // let product = AppDelegate.products[indexPath.row]
        cell.textLabel?.text = AppDelegate.standardNames[indexPath.row]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "elements" {
            ...
            destination.selectedStandard = AppDelegate.standardNames[indexPath!.row]
        }
